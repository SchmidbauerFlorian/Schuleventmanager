...
-- Teachers
CALL create_entity_instance('Teacher', 'name,subject,email,Teacher_id', 'Mr. Smith,Math,smith@htlwy.com,1');           -- 7
CALL create_entity_instance('Teacher', 'name,subject,email,Teacher_id', 'Frau Huber,Physics,huber@htlwy.com,2');       -- 8
-- Rooms
